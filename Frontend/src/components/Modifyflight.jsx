...
ismounted=false;
    ...
    componentDidMount()
    {
        ...
        Flightservice.getflightbyid(this.state.id).then((res)=>{
            let flight=res.data;
            this.setState({source: flight.source,destination: flight.destination,tseats: flight.tseats,as:flight.as,price:flight.price,aid:flight.aid});
        });
    }
    ...
    updateflight = (e) =>
    {
        ...
        e.preventDefault();
        let flight={aid:this.state.aid,source: this.state.source,destination: this.state.destination,tseats: this.state.tseats,as:this.state.as,price:this.state.price};
